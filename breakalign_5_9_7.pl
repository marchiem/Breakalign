...
unless ($blast_path) {
	...
	print "1. blast path is ".$blast_path."\n";
	$blast_path =~  s/blastn$//;
	...
	print "2. blast path is ".$blast_path."\n";
}

print "3. blast path is ".$blast_path."\n";
...
if ($uref)
{
...
elsif ($coo)
    {
        ...
        unless ($coo eq "") {print "Referece sequence will be extracted from coordinates ".$coo."\n"} else {print "Please provide Genomic coordinates\n";exit;};
